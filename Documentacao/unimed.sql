...
CREATE TABLE IF NOT EXISTS `beneficiario` (
  ...
  `localatendimento` int(20) DEFAULT NULL,
...
--
-- Estrutura da tabela `lotacaobeneficiario`
--

CREATE TABLE `unimed`.`lotacaobeneficiario` (
`AutoId` INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`Beneficiario` INT( 10 ) NOT NULL ,
`InicioVigencia` DATE NOT NULL ,
...
CREATE TABLE `unimed`.`localdeatendimento` (
`AutoId` INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`Beneficiario` INT( 10 ) NOT NULL ,
...
`idRegistro` INT( 10 ) NOT NULL AUTO_INCREMENT PRIMARY KEY ,
`idBeneficiario` INT( 10 ) NOT NULL ,
`RG` varchar(35) NOT NULL ,
`PIS` varchar(35) NOT NULL ,
) ENGINE = MYISAM ;

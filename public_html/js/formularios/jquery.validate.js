 ...
 *
 *	Alterado por Paulo Victor Gomes
 *					paulo.gomes@profpv.com
 *
 */
...
jQuery.validator.addMethod("cpf", function(value, element) {
   value = jQuery.trim(value);
	...
	return true;
}, "<br> CPF inválido"); // Mensagem padrão 


//CRIADO POR PV 01/06/2011 - paulo.gomes@season.com.br
...
}, "<br> Informe um Nº PIS válido."); // Mensagem padrão 

//CRIADO POR PV 07/06/2011 - raphael.valerio@season.com.br
jQuery.validator.addMethod("rg", function(value, element) {
   value = jQuery.trim(value);
	...
	{
		 return false;	 
	}else if(value == "999999999" || value == "11111111"){
...
}, "<br> Informe RG correto ."); // Mensagem padrão 


//CRIADO POR PV 07/06/2011 - raphael.valerio@season.com.br
jQuery.validator.addMethod("declaracao", function(value, element) {
   value = jQuery.trim(value);
...
}, "<br> Informe ."); // Mensagem padrão 
/*
jQuery.validator.addMethod("retroativa", function(value, element) {

		//COMEÇO A FATIAR A DATA 
		var dia = $(value).val().substring(0,2);
		var mes = $(value).val().substring(3,5);
		var ano = $(value).val().substring(6);
		...
		//O MES COMEÇA EM ZERO ENTÃO SOMO 1 
		mesHoje = mesHoje + 1
...
jQuery.validator.addMethod("dateBR", function(value, element) {
	...
	return true;
}, "<br>Data inválida");  // Mensagem padrão 
